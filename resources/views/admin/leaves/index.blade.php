...
<div class="mb-8">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="mt-4 sm:mt-0 flex space-x-3">
            <button class="px-4 py-2 bg-yellow-600 hover:bg-yellow-700 text-white font-medium rounded-lg transition-colors shadow-sm hover:shadow-md btn-hover">
    ...
    <div class="bg-white rounded-xl shadow-lg p-6 border border-gray-100 card-hover">
        <div class="flex items-center">
            ...
            <div class="ml-4">
                ...
                <p class="text-2xl font-bold text-gray-900">{{ $leaves->count() }}</p>
            </div>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
    <div class="p-6 border-b border-gray-200">
        ...
        <p class="text-gray-600 mt-1">All employee leave applications</p>
    </div>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        <div class="text-gray-400">to {{ $leave->end_date }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        ...
                        @if($leave->status == 'pending')
                            <div class="flex space-x-2">
                                <form action="{{ route('admin.leaves.approve', $leave->id) }}" method="POST" class="inline">
                                    @csrf
                                    <button type="submit" class="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-50 transition-colors">
                ...
                <tr>
                    <td colspan="6" class="px-6 py-12 text-center">
                        <div class="flex flex-col items-center justify-center py-12">
                            ...
                            <p class="text-gray-500">There are currently no leave applications to review</p>
                        </div>
                    </td>
                </tr>
                @endforelse
